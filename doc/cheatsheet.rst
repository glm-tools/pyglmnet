...
.. math::
    ...
    &-\log(\Gamma(\theta))+\theta\log(\theta)-\log(\mu_i + \theta)(y_i+\theta))+y_i\log(\mu_i)
...
.. math::
    ...
    \frac{\partial J}{\partial \beta_0} &=\frac{1}{N}\sum_{i=0}^{N} \mu_i' \left( \frac{\theta + y_i}{\mu_i+\theta} -\frac{y_i}{\mu_i} \right)\\
    \frac{\partial J}{\partial \beta_j} &=\frac{1}{N}\sum_{i=0}^{N} \mu_i' x_{ij} \left( \frac{\theta + y_i}{\mu_i+\theta} -\frac{y_i}{\mu_i} \right)
