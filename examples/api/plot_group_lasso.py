...
##########################################################
#Group Lasso Example
#similar to method in ftp://ftp.stat.math.ethz.ch/Manuscripts/buhlmann/lukas-sara-peter.pdf
#
##########################################################
...
def find_interaction_index(seq, subseq, alphabet = "ATGC", all_possible_len_n_interactions = None):
    ...
    subseq = set(subseq)
    # print subseq
    # print alphabet_interactions
    # print all_possible_len_n_interactions
...
def create_feature_vector_for_sequence(seq, alphabet = "ATGC", interactions = [1, 2, 3]):
    ...
    # print "len of feature vector: ", feature_vector_length
    ...
    for inter in interactions:
        ...
        # all_possibles = ["".join(p) for p in list(itertools.combinations(alphabet, inter))]
...
print positive_vector_matrix.shape
print negative_vector_matrix.shape

# print positive_vector_matrix[0:5, 0:100]
