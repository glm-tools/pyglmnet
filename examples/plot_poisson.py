...
Dr = glm_poisson[0].deviance(yr, yrhat)
Dt = glm_poisson[0].deviance(yt, ythat)
print(Dr, Dt)

# Compute pseudo-R2s
R2r = glm_poisson[0].pseudo_R2(yr, yrhat, np.mean(yr))
R2t = glm_poisson[0].pseudo_R2(yt, ythat, np.mean(yr))
print(R2r, R2t)
